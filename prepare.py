import os
import json
from maskrcnn_benchmark.DOTA_devkit.ImgSplit_multi_process import splitbase
from maskrcnn_benchmark.DOTA_devkit.SplitOnlyImage_multi_process import splitbase as splitbase_onlyimg
