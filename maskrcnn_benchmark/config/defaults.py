...
_C.INPUT.SQUARE_ROTATE_TRAIN = False
_C.INPUT.SORT_VERTICES = False
_C.INPUT.RANDOM_ROTATE_ON = False
_C.INPUT.ROTATE90_PROB_TRAIN = 0.0
_C.INPUT.CROP_TRAIN = False
_C.INPUT.RECT_TRAIN = False
...
_C.MODEL.ROI_BOX_HEAD.NUM_CLASSES = 17
...
_C.SOLVER.CHECKPOINT_START_STEP = 0
